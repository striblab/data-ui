    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seealsoid', models.ForeignKey(blank=True, db_column='SeeAlsoID', db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='business_companies.Company')),
            ],
            options={
